/* EXAMPLE: cg_device_list_by_location */
...
int main(void)
{
	...
	cg_init("example_device_list_by_location");
	printf("cg_device_list_by_location\n");
	 ...
	 * Setup
	 */
	stat = cg_device_list_by_location(CG_LOC_MAIN, CG_DEVTYPE_NETWORK | CG_DEVTYPE_SERIAL, &num_devices, &devices);
	switch (stat)
	{
