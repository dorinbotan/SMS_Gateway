...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ...
  ifneq ($(CONFIG_TARGET_ROOTFS_SQUASHFS),)
    define Image/mkfs/squashfs
		...
		$(MKSQUASHFS_CMD) $(TARGET_DIR) $(KDIR)/root.squashfs -nopad -noappend -root-owned $(SQUASHFS_OPTS) -key $(CONFIG_KERNEL_SIGN_KEYIDX) $(CONFIG_KERNEL_SIGN_KEYPATH) -desc '$(shell (echo -n 'engineering-'; date +'%Y%m%d%H%M%S'; git describe --tags --exact-match HEAD 2>/dev/null) | tail -n 1)'
