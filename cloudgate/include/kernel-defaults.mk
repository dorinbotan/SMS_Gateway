...
define Kernel/Configure/Default
	...
	echo "$(if $(CONFIG_KERNEL_SIGN_KEYIDX),CONFIG_SIGN_KEYIDX=$(CONFIG_KERNEL_SIGN_KEYIDX),# CONFIG_SIGN_KEYIDX is not set)" >> $(LINUX_DIR)/.config.target
	echo "$(if $(CONFIG_KERNEL_SIGN_KEYPATH),CONFIG_SIGN_KEYPATH=$(CONFIG_KERNEL_SIGN_KEYPATH),# CONFIG_SIGN_KEYPATH is not set)" >> $(LINUX_DIR)/.config.target
