...
#define __GMP_CC "arm-openwrt-linux-uclibcgnueabi-gcc"
#define __GMP_CFLAGS "-Os -pipe -march=armv5te -mtune=xscale -funit-at-a-time -fhonour-copts -msoft-float -fpic "
