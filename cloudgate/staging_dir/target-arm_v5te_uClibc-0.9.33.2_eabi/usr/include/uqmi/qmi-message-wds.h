...
void qmi_cleanup_wds_start_network_response(struct qmi_wds_start_network_response *res);
...
void qmi_cleanup_wds_get_packet_service_status_response(struct qmi_wds_get_packet_service_status_response *res);
...
void qmi_cleanup_wds_get_packet_statistics_response(struct qmi_wds_get_packet_statistics_response *res);
...
void qmi_cleanup_wds_get_profile_list_response(struct qmi_wds_get_profile_list_response *res);
...
void qmi_cleanup_wds_get_profile_settings_response(struct qmi_wds_get_profile_settings_response *res);
...
void qmi_cleanup_wds_get_default_settings_response(struct qmi_wds_get_default_settings_response *res);
...
void qmi_cleanup_wds_get_current_settings_response(struct qmi_wds_get_current_settings_response *res);
...
void qmi_cleanup_wds_get_autoconnect_setting_response(struct qmi_wds_get_autoconnect_setting_response *res);
...
void qmi_cleanup_wds_get_data_bearer_technology_response(struct qmi_wds_get_data_bearer_technology_response *res);
...
void qmi_cleanup_wds_get_current_data_bearer_technology_response(struct qmi_wds_get_current_data_bearer_technology_response *res);
