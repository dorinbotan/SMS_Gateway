...
void qmi_cleanup_nas_get_signal_strength_response(struct qmi_nas_get_signal_strength_response *res);
...
void qmi_cleanup_nas_network_scan_response(struct qmi_nas_network_scan_response *res);
...
void qmi_cleanup_nas_get_serving_system_response(struct qmi_nas_get_serving_system_response *res);
...
void qmi_cleanup_nas_get_home_network_response(struct qmi_nas_get_home_network_response *res);
...
void qmi_cleanup_nas_get_technology_preference_response(struct qmi_nas_get_technology_preference_response *res);
...
void qmi_cleanup_nas_get_rf_band_information_response(struct qmi_nas_get_rf_band_information_response *res);
...
void qmi_cleanup_nas_get_system_selection_preference_response(struct qmi_nas_get_system_selection_preference_response *res);
...
void qmi_cleanup_nas_get_cell_location_info_response(struct qmi_nas_get_cell_location_info_response *res);
...
void qmi_cleanup_nas_get_system_info_response(struct qmi_nas_get_system_info_response *res);
...
void qmi_cleanup_nas_get_signal_info_response(struct qmi_nas_get_signal_info_response *res);
...
void qmi_cleanup_nas_get_tx_rx_info_response(struct qmi_nas_get_tx_rx_info_response *res);
...
void qmi_cleanup_nas_get_cdma_position_info_response(struct qmi_nas_get_cdma_position_info_response *res);
