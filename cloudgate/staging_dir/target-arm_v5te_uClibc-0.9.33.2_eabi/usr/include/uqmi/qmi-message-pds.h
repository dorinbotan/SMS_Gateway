...
void qmi_cleanup_pds_get_gps_service_state_response(struct qmi_pds_get_gps_service_state_response *res);
...
void qmi_cleanup_pds_get_default_tracking_session_response(struct qmi_pds_get_default_tracking_session_response *res);
...
void qmi_cleanup_pds_get_agps_config_response(struct qmi_pds_get_agps_config_response *res);
...
void qmi_cleanup_pds_get_auto_tracking_state_response(struct qmi_pds_get_auto_tracking_state_response *res);
