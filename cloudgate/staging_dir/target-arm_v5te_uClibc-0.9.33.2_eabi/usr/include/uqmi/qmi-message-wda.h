...
void qmi_cleanup_wda_set_data_format_response(struct qmi_wda_set_data_format_response *res);
...
void qmi_cleanup_wda_get_data_format_response(struct qmi_wda_get_data_format_response *res);
