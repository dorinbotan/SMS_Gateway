...
struct qmi_buf* __qmi_buf_new();
void* __qmi_buf_alloc_static(struct qmi_buf **qbuf, unsigned int len, int align_4_bytes);
char* __qmi_buf_copy_string(struct qmi_buf **qbuf, void *data, unsigned int len);
