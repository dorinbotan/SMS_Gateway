/*
 * libuqmi -- tiny libQMI support implementation
 *
...
typedef void (*request_cb)(struct qmi_dev *qmi, struct qmi_request *req, struct qmi_msg *msg, void *arg);
...
int uqmi_device_open(struct qmi_dev *qmi, const char *path);
void uqmi_device_close(struct qmi_dev *qmi, int hard);

int qmi_request_start(struct qmi_dev *qmi, struct qmi_msg *msg, struct qmi_request *req, request_cb cb);
void qmi_request_cancel(struct qmi_dev *qmi, struct qmi_request *req);
int qmi_request_wait(struct qmi_dev *qmi, struct qmi_request *req, int timeout_sec);
...
int uqmi_service_connect(struct qmi_dev *qmi, QmiService svc, int client_id);
...
void uqmi_notify_read(struct qmi_dev *qmi);
struct qmi_request* qmi_new_request(void *arg);
/** Cancel a request based on the callback and argument */
void uqmi_cancel_request(struct qmi_dev *qmi, request_cb cb, void *arg);
